...
import { workspaces, brandAssets } from '@/lib/db/schema'
    ...
    <div className="p-8 max-w-6xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-[#78829d] mt-1 text-sm">
          {workspace.clientName} — logos, colors, fonts, and brand materials.
        </p>
      </div>

      <BrandAssetsManager items={items} workspaceId={id} />
    </div>
  )
}
