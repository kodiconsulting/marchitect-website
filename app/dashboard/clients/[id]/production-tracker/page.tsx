...
export default async function ClientProductionTrackerPage({
  params,
}: {
  ...
  return (
    <div className="p-8 max-w-6xl mx-auto">
      ...
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-[#252f4a]">Production Tracker</h1>
        <p className="text-[#78829d] mt-1 text-sm">
          {workspace.clientName} — content production status and workflow.
        </p>
      </div>
